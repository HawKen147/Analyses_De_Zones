...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.logo_label = customtkinter.CTkLabel(self.sidebar_frame, text="Que voulez vous faire ?", font=customtkinter.CTkFont(size=20, weight="bold"))
        self.logo_label.grid(row=0, column=0, padx=20, pady=(20, 10))
        self.sidebar_button_1 = customtkinter.CTkButton(self.sidebar_frame,text="Créer dossiers", command=self.sidebar_button_event)
        self.sidebar_button_1.grid(row=1, column=0, padx=20, pady=10)
        self.sidebar_button_2 = customtkinter.CTkButton(self.sidebar_frame,text="Déplacer Vidéos", command=self.sidebar_button_event)
        ...
        # set default values
        #self.sidebar_button_3.configure(state="disabled", text="Disabled CTkButton")    #Désactive le bouton
