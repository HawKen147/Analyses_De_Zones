import controleur.create_excel as create_excel
...
#definit l'apparence graphique par défaut
...
class main_window(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        self.chemin_video_label = customtkinter.CTkLabel(self, text="Entrer le chemin pour récupérer les vidéos de surveillance")
    ...
    #Fonction qui vérifie si le chemin existe
    ...
    #Fonction qui récupere le nombre de caméra, le chemin pour stocker les videos, le chemin pour récuperer les clips vidéos
    #Et récupere l'état de la checkbox
    def get_entrys(self):
    ...
    #Change l'état du bouton (normal ou disabled)
    def valider_button_event(self):
        bool = self.get_entrys()            #Récupere l'état de la checkbox
        if bool :
            self.valider_button.configure(state="normal")
        else :
            self.valider_button.configure(state="disabled")

    #Fonction qui change l'apparence de la fenetre (theme sombre ou claire)
    def change_appearance_mode_event(self, new_appearance_mode: str):
        customtkinter.set_appearance_mode(new_appearance_mode)

    #Fonction qui permet de zoomer ou dézoumer dans l'application
   ...
   #ferme la fenetre correspondante
    ...
    #Foncion qui vide les entrées de l'interface
